...
export const BOARD_DATA: Tile[] = [
  ...
  { id: 18, name: '인천', type: TileType.CITY, price: 900, rent: 280, ownerId: null, buildingLevel: 0, description: '하늘길과 바닷길', icon: '✈️' },
...
export const QUIZ_POOL: QuizQuestion[] = [
  ...
  {
    question: "촌락에서 도시로 이동하는 현상을 무엇이라고 할까요?",
    options: ["이촌향도", "귀농", "도시화", "인구 과밀"],
    correctIndex: 0,
    explanation: "이촌향도는 촌락을 떠나 도시로 향한다는 뜻으로, 산업화 과정에서 나타나는 인구 이동 현상입니다."
  },
  {
